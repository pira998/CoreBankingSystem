                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Create Checking Deposit</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <form class="form" method="post" action="/employee/CheckingDeposits/create">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-info">
                        <h4 class="card-title ">Checking Deposits </h4>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table" id="myTable">
                                ...
                                <tbody>
                                    <tr>
                                      <?php foreach($data['checking_deposits'] as $Deposit):
                                            
                                        ?>
                                             <td><?php echo $Deposit->checking_deposit_id; ?></td>
                                            <td><?php echo $Deposit->account_number; ?></td>
                                            <td><?php echo $Deposit->checking_account_number; ?></td>
