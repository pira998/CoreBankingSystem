                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="form" method="post" action="/employee/savingWithdrawals/create">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table" id="myTable">
                                ...
                                <tbody>
                                    <tr>
                                      <?php foreach($data['saving_withdraws'] as $Withdraw):
                                            
                                        ?>
                                             <td><?php echo $Withdraw->saving_withdraw_id; ?></td>
                                            <td><?php echo $Withdraw->account_number; ?></td>
                                            <td><?php echo $Withdraw->saving_account_number; ?></td>
